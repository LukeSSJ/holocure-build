...
const characters = [
  ...
  { id: "Ing", name: "Inugami Korone", weapon: { name: "Orayo!", icon: "Orayo" } },
  ...
  { id: "Sak", name: "Sakura Miko", weapon: { name: "Sakura Gohei", icon: "Sakura_Gohei" } },
  { id: "Aka", name: "Akai Haato", weapon: { name: "Red Heart", icon: "Red_Heart" } },
  { id: "Yaz", name: "Yazora Mel", weapon: { name: "Kapu Kapu", icon: "Kapu_Kapu" } },
  ...
  { id: "Air", name: "Airani lofifteen", weapon: { name: "Paint Brush", icon: "Paint_Brush" } },
  ...
  { id: "Any", name: "Anya Melfissa", weapon: { name: "Keris", icon: "Keris" } },
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    function addItem(item) {
      if (active.items.length < 6 && !active.items.includes(item))
        active.items.push(item);
    }
    function addStamp(stamp) {
      if (active.stamps.length < 3 && !active.stamps.includes(stamp))
    ...
    function weaponDisabled(weapon) {
      return active.weapons.includes(weapon) || weaponsUsed[weapon.id] || weapon.weapons && weapon.weapons.find((id) => weaponsUsed[id]) || weapon.item && active.items.find((i) => i.id === weapon.item) || weapon.item && active.weapons.find((w) => w.item);
    }
    ...
    function saveBuild() {
      var _a;
      const build = {
        character: ((_a = active.character) == null ? void 0 : _a.id) ?? "",
    ...
    function loadBuild() {
      ...
      if (params.size) {
        ...
        active.weapons = weapons.filter((w) => {
          var _a;
          return (_a = params.get("w")) == null ? void 0 : _a.split(",").includes(w.id);
        });
        active.items = items.filter((i) => {
          var _a;
          return (_a = params.get("i")) == null ? void 0 : _a.split(",").includes(i.id);
        });
        active.stamps = stamps.filter((s) => {
          var _a;
          return (_a = params.get("s")) == null ? void 0 : _a.split(",").includes(s.id);
        });
        return;
      }
    ...
    function getUrl() {
      var _a;
      let character = ((_a = active.character) == null ? void 0 : _a.id) ?? "";
      let weapons2 = active.weapons.map((w) => w.id).join(",");
      let items2 = active.items.map((i) => i.id).join(",");
      let stamps2 = active.stamps.map((s) => s.id).join(",");
      let url = `${location.origin}${location.pathname}?c=${character}&w=${weapons2}&i=${items2}&s=${stamps2}`;
      navigator.clipboard.writeText(url).then(() => alert("Copied to clipboard"));
    }
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock(Fragment, null, [
        createBaseVNode("div", null, [
          createBaseVNode("button", { onClick: saveBuild }, "Save"),
          createBaseVNode("button", { onClick: resetBuild }, "Reset"),
          createBaseVNode("button", { onClick: getUrl }, "Copy URL")
        ]),
        _hoisted_1,
        createBaseVNode("div", null, [
          createTextVNode(" Character: "),
          withDirectives(createBaseVNode("select", {
            "onUpdate:modelValue": _cache[0] || (_cache[0] = ($event) => active.character = $event)
          }, [
            _hoisted_2,
            (openBlock(true), createElementBlock(Fragment, null, renderList(unref(characters), (character) => {
              return openBlock(), createElementBlock("option", {
                key: character.id,
                value: character
              }, toDisplayString(character.name), 9, _hoisted_3);
            }), 128))
          ], 512), [
            [vModelSelect, active.character]
          ])
        ]),
        _hoisted_4,
        createBaseVNode("div", null, [
          ...
          createBaseVNode("div", _hoisted_5, [
            (openBlock(true), createElementBlock(Fragment, null, renderList(activeWeapons.value, (weapon) => {
              return openBlock(), createElementBlock("button", {
                key: weapon.id,
                onClick: ($event) => removeWeapon(weapon),
                class: "item"
              }, [
                createBaseVNode("img", {
        ...
        createBaseVNode("div", null, [
          ...
          createBaseVNode("div", _hoisted_13, [
            (openBlock(true), createElementBlock(Fragment, null, renderList(active.stamps, (stamp) => {
              return openBlock(), createElementBlock("button", {
                key: stamp.id,
                onClick: ($event) => removeStamp(stamp),
                class: "item"
              }, [
                createBaseVNode("img", {
        ...
        createBaseVNode("div", null, [
          ...
          createBaseVNode("div", _hoisted_18, [
            (openBlock(true), createElementBlock(Fragment, null, renderList(unref(weapons), (weapon) => {
              return openBlock(), createElementBlock("button", {
                key: weapon.id,
                onClick: ($event) => addWeapon(weapon),
