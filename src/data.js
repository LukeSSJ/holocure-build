...
export const recipes = [
	...
	},
	{
		...
		icon: "Tuna_Sandwich",
		uses: 5,
		description: "Increase SPD by 25%.",
	},
	{
		id: "Sus",
		name: "Sushi Set",
		icon: "Sushi_Set",
		uses: 3,
		description: "Increase Crit by 10%.",
	},
	{
		id: "Pok",
		name: "Poke Bowl",
		icon: "Poke_Bowl",
		uses: 5,
		description: "Increase Pick Up Range by 40%.",
	},
	{
		id: "Lob",
		name: "Lobster Dinner",
		icon: "Lobster_Dinner",
		uses: 3,
		description: "Increase Haste by 15%.",
	},
	{
		id: "Puf",
		name: "Pufferfish Meal Set",
		icon: "Pufferfish_Meal_Set",
		uses: 3,
		description: "ncrease ATK/SPD/PUR by 20% and Max HP/Crit/Haste by 10%.",
	},
	{
		id: "VeB",
		name: "Vegetarian Burger and Fries",
		icon: "Vegetarian_Burger_and_Fries",
		uses: 5,
		description: "Automatically heal 50% HP if if HP drops below 25% up to 10 times.",
	},
	{
		id: "Una",
		name: "Unagi Don",
	...
	},
	{
		...
		icon: "Fruit_Sandwich",
		uses: 5,
		description: "Targets drop 30% more HoloCoins.",
	},
	{
		id: "Bur",
		name: "Burger Meal",
		icon: "Burger_Meal",
		uses: 5,
		description: "Burgers drop twice as often.",
	},
	{
		id: "VeS",
		name: "Vegetable Soup",
		icon: "Vegetable_Soup",
		uses: 3,
		description: "Every 30 seconds, become invincible to all attacks for 5 seconds.",
	},
	{
		id: "Spi",
		name: "Spicy Seafood Udon",
		icon: "Spicy_Seafood_Udon",
		uses: 5,
		description: "When taking damage, increase Special meter.",
	},
	{
		id: "Str",
		name: "Strange Seafood Soup",
		icon: "Strange_Seafood_Soup",
		uses: 3,
		description: "Greatly increases the chance of Halu IconHalu appearing.",
	},
	{
		id: "BBQ",
		name: "BBQ Squid",
		icon: "BBQ_Squid",
		uses: 3,
		description: "Take 33% less damage from projectile attacks.",
	},
	{
		id: "Tur",
		name: "Turtle Soup",
		icon: "Turtle_Soup",
		uses: 3,
		description: "Greatly increases the chance of all EXP-related items appearing.",
	},
]
